...
try {
  ...
  if (!historicalIndicator.ok || !historicalHtml.includes("321.40000000") || !historicalHtml.includes("historical_as_of") && !historicalHtml.includes("نمای تاریخی")) throw new Error("Historical indicator smoke contract failed.");
